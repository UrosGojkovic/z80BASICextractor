...
char* decompress(long int starting_offset, long int length); //returns block of decompressed memory; if length == NULL, decompress until we hit version 1 ending block "0x00 0xED 0xED 0x00". Return value points to a newly allocated block.
